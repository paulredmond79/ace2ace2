...
| [docs/Hardware.md](docs/Hardware.md) | Hardware requirements, connector pinouts, custom cables, RS485 wiring |
| [docs/BOM.md](docs/BOM.md) | Full bill of materials with part numbers, sources, and cost estimates |
